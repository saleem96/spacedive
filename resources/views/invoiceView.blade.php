...
--}}
                    <div class="m-v-md m-v-lg--tablet">
                        <input type="text" id="reference_no"  value="{{isset($invoice->task) ? $invoice->task->reference_no:''}}"placeholder="Reference number" class="">
                    </div>
                    <div class="m-v-md m-v-lg--tablet">
                    ...
                    <div>
                        <input id="invoice__description" class="invoice__description invoice__description--input inputBorder p-sm ellipsis" type="text" name="description" value="{{$invoice->data->description}}" placeholder="{{__('strings.project_desc')}}" maxlength="255" autocomplete="off"
...
{{--                        <label for="">Company Name</label>--}}
                        <input type="text" id="name"  name="client" placeholder="{{__('strings.company_name')}}" value="{{$invoice->data->client}}" class="">
                    </div>
                </div>
                <div class="flex flex--start">
...
{{--                        <label for="">Registration Number</label>--}}
                        ...
                        <input type="text"  id="num" name="reg_num" placeholder="{{__('strings.registration_num')}}" value="{{$invoice->data->reg_num}}" class="">
                    </div>
                </div>
                ...
                <div class="flex flex--start">
                    ...
                    <div class="m-v-md ">
                        ...
                        <input type="text" id="ean" name="ean" placeholder="{{__('strings.ean')}}" value="{{isset($invoice->data->ean) ? $invoice->data->ean : ''}}" class="">
                    </div>
                </div>
                <div class="flex flex--start">
...
{{--                        <label for="">Billing Address</label>--}}
                        ...
                        <input type="text" id="address"  name="address" placeholder="{{__('strings.billing_address')}}" value="{{$invoice->data->address}}" class="">
                    </div>
                </div>
                <div class="flex flex--start">
...
{{--                        <label for="">Contact Name</label>--}}
                        ...
                        <input type="text" id="cname"  name="contact" placeholder="{{__('strings.contact_name')}}" value="{{$invoice->data->contact}}" class="">
                    </div>
                </div>
                <div class="flex flex--start">
...
{{--                        <label for="">Company Email</label>--}}
                        ...
                        <input type="text"  id="email" name="email" placeholder="{{__('strings.email')}}" value="{{$invoice->data->email}}" class="">
                    </div>
                </div>
                <div class="flex flex--start">
...
{{--                        <label for="">Company Phone</label>--}}
                        ...
                        <input type="text"  id="phone" name="phone" placeholder="{{__('strings.phone')}}"  value="{{$invoice->data->phone}}" class="">
                    </div>
                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="form-check well">
                                <input style="visibility: visible !important;" type="checkbox" class="form-check-input" {{ ($invoice->holiday=="1")? "checked" : ""}}  id="exampleCheck1" name="holiday" value="1">
