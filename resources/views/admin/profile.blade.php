@extends('admin.dashboard',['a' => 'Profile'])
@section('body')
    <div class="row">
            ...
            <div class="card card-profile">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="text-center">
                        ...
                        <div class="h5 mt-4">
                            <a href="{{url('/admin_endplan?id='.$user->id)}}" id="end"><button class="btn btn-sm btn-danger">Cancel Subscription</button></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="plan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form action="{{URL()->to("admin_update-plan")}}" method="post">
            <input type="hidden" name="id" value="{{$user->id}}">
