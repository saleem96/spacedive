...
<div class="es-wrapper-color">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-m-txt-c" align="left">
                                                                <img width="40%"  src="{{url('/images/img-01.png')}}" alt="IMG">
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-m-txt-l es-p15t" align="left">
                                                                <h3>{{__('strings.Hi')}} {{$task->client->name}},</h3>
                                                                <h6>{{$task->user->fname . ' ' . $task->user->lname}} {{__('strings.has created a new gig for you')}}</h6>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="esd-block-text es-p15t es-p10b" align="">
                                                                <p style="font-size: 12px; color: #777777; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;"><span>Ref. </span> {{ $task->reference_no?$task->reference_no:'' }}</p>
                                                            </td>
                                                        </tr>
                                ...
                                <tr>
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$task->name}}</td>
                                            <td>{{$task->price . ' ' . $task->currency}}</td>
                                            <td>{{$task->time}}</td>
                                            <td>{{$task->job_type}}</td>
                                        </tr>
                                        </tbody>
                                ...
                                <tr>
                                    <td class="esd-container-frame" width="530" valign="top" align="center">
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="esd-block-text es-m-txt-l es-p15t" align="left">
                                                    <h5>{{$task->client_msg}}</h5>
                                                    <?php
                                                    $uu = url('/approve_gig_'.$task->id.'?lang='.(App::getLocale() == 'en' ? 'en' : 'danish'));
                                                    ?>
                                                    <h3>{{__('strings.Please approve this gig by clicking on this button')}} : </h3>
                                                    <a href="{{$uu}}"><button style="background-color: #4CAF50; /* Green */
  border: none;
  color: white;
  padding: 15px 32px;
  text-align: center;
  ...
  font-size: 16px;"> {{__('strings.clieck')}}</button></a></td>
                                            </tr>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td align="center" class="esd-empty-container" style="display: none;">
                                                                ...
                                                                <a href="{{url('/approve/gig/'.$task->id)}}"><button > Click Here To Approve</button></a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
