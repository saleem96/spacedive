                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-m-txt-c" align="left">
                                                                <img width="70%" src="<?php echo e(url('/images/img-01.png')); ?>" alt="IMG">
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p15t es-p10b" align="left">
                                                                <p style="font-size: 16px; color: #777777; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;">
                                                                    
                                                                    <h3><?php echo e(__('strings.Hi')); ?> <?php echo e($name); ?>,</h3>
                                                                    <?php echo __('strings.WELCOME_EMAIL_CONTENT_ENG'); ?>
...
<?php /**PATH /home/spacairt/my.spacedive.io/resources/views/emails/welcome.blade.php ENDPATH**/ ?>