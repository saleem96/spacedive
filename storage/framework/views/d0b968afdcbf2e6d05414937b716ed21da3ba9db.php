        ...
        <div class="app">
            ...
            <form id="invoice" method="post" class="card bg-white display--block m-t-md m-t-lg--tablet m-t-xl--desktop m-b-md m-b-lg--tablet" onsubmit="disableSubmitters();">
                ...
                <div class="invoice__titles m-v-md m-v-lg--tablet">
                    ...
                    <div>
                        <input id="invoice__description" class="invoice__description invoice__description--input inputBorder p-sm ellipsis" type="text" name="description" value="<?php echo e($invoice->data->description); ?>" placeholder="Project / Description" maxlength="255" autocomplete="off"
                ...
                <div class="flex flex--start">
                    ...
                    <div class="m-v-md m-v-lg--tablet">
                        ...
                        <input type="text" id="name"  name="client" placeholder="Company Name" value="<?php echo e($invoice->data->client); ?>" class="">
                    </div>
                </div>
                <div class="flex flex--start">
                    ...
                    <div class="m-v-md m-v-lg--tablet">
                        ...
                        <input type="text"  id="num" name="reg_num" placeholder="Registration Number" value="<?php echo e($invoice->data->reg_num); ?>" class="">
                    </div>
                </div>
                <div class="flex flex--start">
                    ...
                    <div class="m-v-md m-v-lg--tablet">
                        ...
                        <input type="text" id="address"  name="address" placeholder="Billing Address" value="<?php echo e($invoice->data->address); ?>" class="">
                    </div>
                </div>
                <div class="flex flex--start">
                    ...
                    <div class="m-v-md m-v-lg--tablet">
                        ...
                        <input type="text" id="cname"  name="contact" placeholder="Contact Name" value="<?php echo e($invoice->data->contact); ?>" class="">
                    </div>
                </div>
                <div class="flex flex--start">
                    ...
                    <div class="m-v-md m-v-lg--tablet">
                        ...
                        <input type="text"  id="email" name="email" placeholder="Email" value="<?php echo e($invoice->data->email); ?>" class="">
                    </div>
                </div>
                <div class="flex flex--start">
                    ...
                    <div class="m-v-md m-v-lg--tablet">
                        ...
                        <input type="text"  id="phone" name="phone" placeholder="Phone"  value="<?php echo e($invoice->data->phone); ?>" class="">
                    </div>
                </div>
...
<?php echo $__env->make('admin.dashboard',['a' => 'View Invoice'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/spacairt/my.spacedive.io/resources/views/admin/invoiceView.blade.php ENDPATH**/ ?>