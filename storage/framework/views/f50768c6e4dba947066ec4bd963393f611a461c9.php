...
<div class="es-wrapper-color">
                ...
                <table class="es-content" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                        <td class="esd-stripe" esd-custom-block-id="7681" align="center">
                            <table class="es-header-body" style="background-color: #ffffff;" width="600" cellspacing="0" cellpadding="0" bgcolor="#044767" align="center">
                                <tbody>
                                <tr>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-m-txt-c" align="left">
                                                                <img width="40%"  src="<?php echo e(url('/images/img-01.png')); ?>" alt="IMG">
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-m-txt-l es-p15t" align="left">
                                                                <h3><?php echo e(__('strings.Hi')); ?> <?php echo e($task->client->name); ?>,</h3>
                                                                <h6><?php echo e($task->user->fname . ' ' . $task->user->lname); ?> <?php echo e(__('strings.has created a new gig for you')); ?></h6>
                                                            </td>

                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p15t es-p10b" align="left">
                                                                <p style="font-size: 16px; color: #777777; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;"> Gig Info</p>
                                                            </td>
                                                            <td class="esd-block-text es-p15t es-p10b" align="">
                                                                <p style="font-size: 12px; color: #777777; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;"><span>Ref. </span> <?php echo e($task->reference_no?$task->reference_no:''); ?></p>
                                                            </td>
                                                        </tr>
                                ...
                                <tr>
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e(__('strings.price')); ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($task->price . ' ' . $task->currency); ?></td>
                                ...
                                <tr>
                                    <td class="esd-container-frame" width="530" valign="top" align="center">
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="esd-block-text es-m-txt-l es-p15t" align="left">
                                                    <h5><?php echo e($task->client_msg); ?></h5>
                                                    <?php
                                                    $uu = url('/approve_gig_'.$task->id.'?lang='.(App::getLocale() == 'en' ? 'en' : 'danish'));
                                                    ?>
                                                    <h3><?php echo e(__('strings.Please approve this gig by clicking on this button')); ?> : </h3>
                                                    <a href="<?php echo e($uu); ?>"><button style="background-color: #4CAF50; /* Green */
  border: none;
  color: white;
  padding: 15px 32px;
  text-align: center;
  ...
  font-size: 16px;"> <?php echo e(__('strings.clieck')); ?></button></a></td>
                                            </tr>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td align="center" class="esd-empty-container" style="display: none;">
                                                                Please Click here to approve this gig
                                                                <a href="<?php echo e(url('/approve/gig/'.$task->id)); ?>"><button > Click Here To Approve</button></a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
...
<?php /**PATH /home/spacairt/my.spacedive.io/resources/views/emails/gig.blade.php ENDPATH**/ ?>