                            ...
                            <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-m-txt-l es-p15t" align="left">
                                                                <h3><?php echo e(__('strings.Hi')); ?> <?php echo e($name); ?>,</h3>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p15t es-p10b" align="left">
                                                                <p style="font-size: 16px; color: #777777; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;"> <?php echo e(__('strings.plan_update') . ' ' .$payment['plan_name']); ?></p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                ...
                                <tr>
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                        <tbody>
                                        <tr>
                                            <td><?php echo e(__('strings.plan_name')); ?></td>
                                            <td><?php echo e(__('strings.amount1')); ?></td>
                                            <td><?php echo e(__('strings.paid')); ?></td>
                                            <td><?php echo e(__('strings.card')); ?></td>
                                        </tr>
                                        <tr>
...
<?php /**PATH /home/spacairt/my.spacedive.io/resources/views/emails/receipt.blade.php ENDPATH**/ ?>